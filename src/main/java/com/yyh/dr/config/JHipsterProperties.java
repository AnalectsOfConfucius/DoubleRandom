...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "DoubleRandom@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "DoubleRandom API";

        private String description = "DoubleRandom API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "DoubleRandom";
